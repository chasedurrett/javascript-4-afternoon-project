...
User.prototype.addSavedPost = function (id, title, rating) {
  let userSavedPosts = { id, title, rating };
  this.savedPosts.push(userSavedPosts);
};
...
// Code here
/*User.prototype.removeSavedPost = function (id) {              ||    <<<<<<<<< my first attempt which works but isn't efficient 
...
User.prototype.removeSavedPost = function (id) {
  let match = this.savedPosts.indexOf(id);
  this.savedPosts.splice(match, 1);
  console.log(this.savedPosts);
};

// {id: 1, title: "Log Cabin", rating: 4}
// {id: 2, title: "Hard Core Quilting", rating: 5}
